...
\begin{verbatim}
2I1,F6.4,F8.4,F8.4,I1,3F8.4,I2  KQMAX,PP,THMIN,THMAX,THINC,KOORDS,CUTL,CUTR,CUTC,DGAM
\end{verbatim}
...
\\ 
If DGAM$>$0:  generate angular distributions for gammas of multiplicity LGAM for decay
of excited states of whichever final nucleus is specified by PP,1
